...
{
    [CDSTable("Office", "DB", "")]
    public class CclRecOffice : CclCDSRecBase
    {
        #region Constants
        ///**************************************************
        /// Constants
        ...
        /// </summary>
        public CclRecOffice() : this(string.Empty, int.MinValue, string.Empty, true, false, false, false) { }
        ...
        public CclRecOffice(string _strProductName, int _intAmount, string _strUserName, bool _boolIsPreOrdered, bool _boolIsOrdered, bool _boolIsReceived, bool _boolIsDeleted)
        {
